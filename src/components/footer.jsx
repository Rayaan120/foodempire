...
const Footer = () => {
  return (
    <footer className="bg-emerald-100 text-emerald-900 py-6 md:py-8 relative overflow-hidden">
      {/* Background Overlay */}
      <div className="absolute inset-0 bg-emerald-200/30 pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* ✅ Bottom Strip */}
        <div className="border-t border-emerald-300 pt-3 pb-2 text-center">
